...
#define MIRYOKU_ALTERNATIVES_BASE_CUSTOM_QWERTY \
...
#define MIRYOKU_ALTERNATIVES_CUSTOM_SYM \
...
#define MIRYOKU_ALTERNATIVES_CUSTOM_NUM \
...
#define MIRYOKU_ALTERNATIVES_MEDIA_CUSTOM_VI \
...
#define MIRYOKU_ALTERNATIVES_NAV_CUSTOM_VI \
