...
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, ESC),  U_LT(U_NUM, LALT),U_LT(U_SYM, RET),  &kp SPC, U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NA,              &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              &kp RC(BSPC),      &kp BSPC,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp TAB,          &kp DEL,           U_NP,              U_NP
